   ...
   <div class="container-fluid">
      ...
      <div class="col-sm-6">
         <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Gallery Paket </li>
         </ol>
      </div>
      </div>
   </div>
         ...
         <div class="col-lg">
            <div class="card card-primary card-outline">
               <div class="card-header">
                  <h5 class="card-title">Data Gallery Paket </h5>
                  <a href="{{ route('paket-gallery.create')}}" class="btn btn-sm btn-primary shadow-sm float-right">
                     <i class="fas fa-plus fa-sm text-white-50"></i> Tambah Gallery Paket 
                  </a>
               </div>
               <div class="card-body">
                  @if (session('status'))
                  ...
                  <table id="list-data" class="table table-bordered table-striped">
                     ...
                     @forelse ($items as $item)
                        <tr>
                           <td>{{ $no }}</td>
                           <td>{{ $item->tour_packages->judul}}</td>
                           ...
                           <td style="width: 15%">
                              ...
                              <form action="{{ route('paket-gallery.destroy', $item->id)}}" method="post" class="d-inline">  
                                 @csrf
                                 @method('delete')
